        ...
        <div class="page-section">
            ...
            <div class="flex-row late-row" style="align-items: flex-start;">
                <div class="shadow-div row-item">
                    ...
                    <p class="page-p email-address"><a href="mailto:igorwichrowski@gmail.com">igorwichrowski@gmail.com</a></p>
                </div>
                <div>
                    <button class="more-button" type="button">Dowiedz się więcej!</button>
                    <p class="page-p more-about-points">Grupa Dekanatu Nakło nad Notecią, która wyjeżdża na Światowe Dni Młodzieży liczy około 50 osób. Spotykamy się w każdy drugi piątek miesiąca na wspólnej Eucharystii i spotkaniu formacyjnym a także zgłębiamy historie Portugalii.
                        Wyjeżdżamy 21 lipca 2023 roku i wracamy 10 sierpnia 2023 roku. Jadąc na Światowe Dni Młodzieży zwiedzamy Paryż, Lourdes, Oviedo, Santiago de Compostela, Porto, Fatimę, a wracając jedziemy do Barcelony oraz na wypoczynek nad Jeziora Bodenskie w Szwajcarii.
                        Koszt wyjazdu wynosi 3000 zł i 300 euro, bez pakietu pielgrzyma. Na pakiety pielgrzyma zbieramy poprzez różne akcje charytatywne, tj. Sprzedaż ciasta, Zbiórka do puszek i inne, które podejmujemy każdego miesiąca.
                        Serdecznie zapraszamy każdego, aby wraz z Dekanatem Nakło wyruszył na piękne modlitewne spotkanie do Lizbony.</p>
                </div>
            </div>
        </div>
        <a id="osowagora-a"></a>
        ...
        <div class="page-section">
            ...
            <div class="flex-row late-row" style="align-items: flex-start;">
                <div class="shadow-div row-item">
                    ...
                    <p class="page-p email-address"><a href="mailto:ks.wojciech.ciolek@gmail.com">ks.wojciech.ciolek@gmail.com</a></p>
                </div>
                <div>
                    <button class="more-button" type="button">Dowiedz się więcej!</button>
                    <p class="page-p more-about-points">Jest nas 53 mlodych i pieknych ktorzy chcemy spotkac sie z papiezem w Lizbonie i cieszyc sie wiara w Jezusa! Ruszamy 27 lipca. O 21.00 msza swieta, potem 5h w autobusie kierujac sie do Berlina. Lot i zaczynamy zdobywac Portugalie. 28 i 29 lipca Porto, 30 lipca zwiedzamy Coimbre, Nazare i spedzamy popoludnie w Fatimie. Wieczorem w Lizbonie sie meldujemy! 31 lipca odwiedzamy wszytsko co ciekawe w tym miescie. Od 1 sierpnia do 6 uczestniczymy w Centralnych wydarzeniach SDM. Spotykamy sie co miesiac na mszy i czuwaniu i spotkaniu formacyjnym.
                        Brak możliwości zapisu</p>
                </div>
            </div>
        </div>
        <a id="fordon-a"></a>
