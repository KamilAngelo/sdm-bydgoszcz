    ...
    <div class="content">
        <section class="index-section section1">
            <div class="flex-row" style="justify-content: space-between;">
                <div class="section1-items">
                    ...
                    <p class="section1-p section-p">Dołącz do jednej z grup, które już w lipcu wezmą udział w największym chrześcijańskim evencie dla młodych!</p>
                </div>
        ...
        <section class="index-section section2">
            ...
            <div class="swiper zindex10">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama1.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama1a.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama1b.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama2.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama3.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama4.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama5.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama6.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama7.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama8.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama9.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama11.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama12.jpg"></div>
                    <div class="swiper-slide"><img src="<?php bloginfo('template_url'); ?>/media/panama/panama13.jpg"></div>
                </div>
        ...
        <section class="index-section section3">
                ...
                <div class="flex-row" style="width: 100%;">
                    <p class="section3-p section-p row-item" >
                    ...
                    <iframe class="row-item" width="560" height="315" src="https://www.youtube.com/embed/JUiBADEot90" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        ...
        <section class="index-section section4">
            <div class="content" style="max-width: 100%; width: 100%; padding: 0;">
                <h1 class="big-h1" style="color:var(--darkcontent); font-weight: 500;">
                    Grupy wyjeżdżające na ŚDM z naszej Diecezji
                </h1>
                <div class="grupy-row">
                    <div class="grupa-div shadow-div">
                        <h2 class="page-h3">Grupa Złotów</h2>
                        <p class="page-p" style="font-size: 15px; text-align: left;">Organizator: Parafie złotowskie</p>
                        <p class="page-p" style="font-size: 15px; text-align: left;">Koordynatorzy: <br />ks. Bartłomiej Brzeziński, <br />ks. Marcin Przystawski MSF</p>
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#zlotow-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
                        ...
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#naklo-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
                        ...
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#osowagora-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
                        ...
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#fordon-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
                        ...
                        <p class="page-p" style="font-size: 15px; text-align: left;">Koordynator: ks. Henryk Stippa</p>
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#centralna-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
                        ...
                        <a href="<?php echo site_url('/punkty-przygotowan/'); ?>#studencka-a" style="color: white;"><button class="more-button">Więcej informacji</button></a>
                    </div>
                    <div class="grupa-div shadow-div">
