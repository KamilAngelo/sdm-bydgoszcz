...
<div class="container">
    <div class="content page-content">
        ...
        <div class="page-section">
            <h3 class="page-h3" style="text-align: left;">Diecezje w Portugalii:</h3>
            <img style="float: right; margin: 0px 0px 20px 30px; box-shadow: none;" class="page-img" src="https://sdmpolska.pl/assets/www/69/dni-w-diecezjach16506209081.jpg" alt="diecezje" />
            <p class="page-p">Algarve, Angra, Aveiro, Beja, Braga, Bragança-Miranda, Coimbra, Évora, Funchal, Guarda, Lamego, Leiria-Fátima, Portalegre-Castelo Branco, Porto, Viana do Castelo, Vila Real i Viseu - te portugalskie diecezje przyjmą pielgrzymów, którzy przed tygodniem wydarzeń centralnych w Lizbonie, będą chcieli lepiej poznać lokalny Kościół i spędzić czas z mieszkańcami Portugalii.</p>
            <p class="page-p">Wzorem poprzednich edycji, pielgrzymi, którzy sami wybiorą diecezję, do której się chcą udać i odpowiednio wcześniej się w niej zarejestrują, będą zaproszeni do udziału w programie duchowym i kulturalnym, przygotowanym przez każdą z diecezji. Zamieszkają w większości u portugalskich rodzin, co także jest ważnym i cenionym elementem tego etapu spotkania młodych. </p>
        </div>
        <div class="page-section">
        ...
        <div class="page-section">
            ...
            <p class="page-p" style="border-radius: 30px; text-align: left;">Maryjo, Pani Nawiedzenia,<br/>
                ...
                Pójdziemy z pośpiechem, bez zbytnich rozproszeń i bez zwłoki, z zapałem i radością.<br/>
                Pójdziemy pełni pokoju, gdyż ten, kto niesie Chrystusa, niesie pokój,<br/>
                a czynienie dobra jest najlepszym sposobem istnienia.<br/>
                Maryjo, Pani Nawiedzenia,<br/>
                niech za Twoją przyczyną ten Światowy Dzień Młodzieży stanie się dla nas wspólnym uwielbieniem Chrystusa, którego niesiemy, tak jak Ty go nosiłaś. <br/>
                Spraw, niech stanie się okazją do świadectwa i wzajemnego dzielenia się, do braterstwa i wdzięczności, do  poszukiwania tych, którzy wciąż czekają na Chrystusa.<br/>
                Maryjo,<br/>
                razem z Tobą przejdziemy tę drogę spotkania, by także nasz świat<br/>
                mógł zjednoczyć się w braterstwie, sprawiedliwości i pokoju.<br/>
                Pani Nawiedzenia,<br/>
                pomóż nam zanieść Chrystusa wszystkim,<br/>
                w posłuszeństwie Ojcu i w miłości Ducha.</p>
        </div>
        <div class="bar" style="margin-top: 30px;"></div>
        <div class="page-section">
            ...
            <p class="page-p">Po raz pierwszy w logotypie umieszczono też różaniec – nawiązanie do duchowości maryjnej silnie obecnej w portugalskim Kościele, a zwłaszcza do historii fatimskich objawień. Jednym z elementów jest też podobizna Maryi, przedstawionej, jako młoda dziewczyna, gotowa do drogi i do odpowiedzi na Boże wezwanie.
            </p>
            <p class="page-p">Autorką logo jest młoda Portugalka, Beatriz Roque Antunes, która ukończyła studia graficzne w Londynie i pracuje obecnie w stolicy Portugalii. Jak informują organizatorzy, jej praca została wybrana spośród kilkuset propozycji, nadesłanych z ok. 30 państw na świecie. Na dzień prezentacji logo, Portugalczycy wybrali 16 października, dzień 42. rocznicy wyboru na Stolicę Piotrową Jana Pawła II – inicjatora Światowych Dni Młodzieży.</p>
        </div>
        <div class="bar" style="margin-top: 30px;"></div>
        <div class="page-section">
...
<script>
    document.getElementById('more-proclamation-button').addEventListener('click', () => {
        document.getElementById('more-proclamation-button').style.display="none";
        document.getElementById('more-proclamation').style.display="inline-block";
    })
</script>
